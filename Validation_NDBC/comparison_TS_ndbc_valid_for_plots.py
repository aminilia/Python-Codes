...
ncfile=nc.Dataset('Comb_his_WL_sm0_5.nc')
...
#comp2=fig.add_trace(go.Scatter(x=df_model1.index , y=df_model1[11], mode='lines', name='model_Smag=1.0' ))
#comp3=fig.add_trace(go.Scatter(x=df_model2.index , y=df_model2[11], mode='lines', name='model_Smag=0.5' ))
comp4=fig.add_trace(go.Scatter(x=df_model3.index , y=df_model3[11], mode='lines', name='model' ))
...
fig.update_layout(title='<b>Comparison for '+merged_stname[11][5:10]+'<b>',
                  ...
                  height=400)
fig.show()
plt.savefig(merged_stname[11][5:25]+'.png', format='png', dpi=300)
...
#comp2=fig.add_trace(go.Scatter(x=df_model1.index , y=df_model1[11], mode='lines', name='model_Smag=1.0' ))
#comp3=fig.add_trace(go.Scatter(x=df_model2.index , y=df_model2[11], mode='lines', name='model_Smag=0.5' ))
comp4=fig.add_trace(go.Scatter(x=df_model3.index , y=df_model3[6], mode='lines', name='model' ))
...
fig.update_layout(title='<b>Comparison for '+merged_stname[6][5:10]+'<b>',
                  ...
                  height=400)
fig.show()
plt.savefig(merged_stname[6][5:25]+'.png', format='png', dpi=300)
...
#comp2=fig.add_trace(go.Scatter(x=df_model1.index , y=df_model1[11], mode='lines', name='model_Smag=1.0' ))
#comp3=fig.add_trace(go.Scatter(x=df_model2.index , y=df_model2[11], mode='lines', name='model_Smag=0.5' ))
comp4=fig.add_trace(go.Scatter(x=df_model3.index , y=df_model3[7], mode='lines', name='model' ))
...
fig.update_layout(title='<b>Comparison for '+merged_stname[7][5:10]+'<b>',
                  ...
                  height=400)
fig.show()
plt.savefig(merged_stname[7][5:25]+'.png', format='png', dpi=300)
...
#comp2=fig.add_trace(go.Scatter(x=df_model1.index , y=df_model1[11], mode='lines', name='model_Smag=1.0' ))
#comp3=fig.add_trace(go.Scatter(x=df_model2.index , y=df_model2[11], mode='lines', name='model_Smag=0.5' ))
comp4=fig.add_trace(go.Scatter(x=df_model3.index , y=df_model3[15], mode='lines', name='model' ))
...
fig.update_layout(title='<b>Comparison for '+merged_stname[15][5:10]+'<b>',
                  ...
                  height=400)
fig.show()
plt.savefig(merged_stname[15][5:25]+'.png', format='png', dpi=300)
...
#comp2=fig.add_trace(go.Scatter(x=df_model1.index , y=df_model1[11], mode='lines', name='model_Smag=1.0' ))
#comp3=fig.add_trace(go.Scatter(x=df_model2.index , y=df_model2[11], mode='lines', name='model_Smag=0.5' ))
comp4=fig.add_trace(go.Scatter(x=df_model3.index , y=df_model3[8], mode='lines', name='model' ))
...
fig.update_layout(title='<b>Comparison for '+merged_stname[8][5:10]+'<b>',
                  ...
                  height=400)
fig.show()
plt.savefig(merged_stname[8][5:25]+'.png', format='png', dpi=300)
...
#comp2=fig.add_trace(go.Scatter(x=df_model1.index , y=df_model1[11], mode='lines', name='model_Smag=1.0' ))
#comp3=fig.add_trace(go.Scatter(x=df_model2.index , y=df_model2[11], mode='lines', name='model_Smag=0.5' ))
comp4=fig.add_trace(go.Scatter(x=df_model3.index , y=df_model3[13], mode='lines', name='model' ))
...
fig.update_layout(title='<b>Comparison for '+merged_stname[13][5:10]+'<b>',
                  ...
                  height=400)
fig.show()
plt.savefig(merged_stname[13][5:25]+'.png', format='png', dpi=300)
...
#comp2=fig.add_trace(go.Scatter(x=df_model1.index , y=df_model1[11], mode='lines', name='model_Smag=1.0' ))
#comp3=fig.add_trace(go.Scatter(x=df_model2.index , y=df_model2[11], mode='lines', name='model_Smag=0.5' ))
comp4=fig.add_trace(go.Scatter(x=df_model3.index , y=df_model3[10], mode='lines', name='model' ))
...
fig.update_layout(title='<b>Comparison for '+merged_stname[10][5:10]+'<b>',
                  ...
                  height=400)
fig.show()
plt.savefig(merged_stname[10][5:25]+'.png', format='png', dpi=300)
...
stat.to_csv('stats_ndbc_current_sd4.csv')
...
taylor_diagram(STD,RMSE,Corr,markerLabel=label,
