...
print(merged_df['9.6'].corr(merged_df['9.6o']))
print(merged_df['19.6'].corr(merged_df['19.6o']))
print(merged_df['33.6'].corr(merged_df['33.6o']))

print(merged_df['9.6'].std())
print(merged_df['19.6'].std())
print(merged_df['33.6'].std())

print(merged_df['9.6o'].std())
print(merged_df['19.6o'].std())
print(merged_df['33.6o'].std())

print(np.mean(merged_df['9.6']-merged_df['9.6o']))
print(np.mean(merged_df['19.6']-merged_df['19.6o']))
print(np.mean(merged_df['33.6']-merged_df['33.6o']))

print(np.sqrt(np.sum((merged_df['9.6']-merged_df['9.6o'])**2)/len(merged_df['9.6'])))
print(np.sqrt(np.sum((merged_df['19.6']-merged_df['19.6o'])**2)/len(merged_df['19.6'])))
print(np.sqrt(np.sum((merged_df['33.6']-merged_df['33.6o'])**2)/len(merged_df['33.6'])))
...
plt.savefig('Current_Rose_9.6_model_clinic.png')
...
plt.savefig('Current_Rose_19.6_model_clinic.png')
...
plt.savefig('Current_Rose_33.6_model_clinic.png')

# %% Winter

print(merged_df['9.6'].loc[datetime(2018,12,20):datetime(2019,3,20)] \
      .corr(merged_df['9.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)]))
print(merged_df['19.6'].loc[datetime(2018,12,20):datetime(2019,3,20)] \
      .corr(merged_df['19.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)]))
print(merged_df['33.6'].loc[datetime(2018,12,20):datetime(2019,3,20)] \
      .corr(merged_df['33.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)]))

print(merged_df['9.6'].loc[datetime(2018,12,20):datetime(2019,3,20)].std())
print(merged_df['19.6'].loc[datetime(2018,12,20):datetime(2019,3,20)].std())
print(merged_df['33.6'].loc[datetime(2018,12,20):datetime(2019,3,20)].std())

print(merged_df['9.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)].std())
print(merged_df['19.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)].std())
print(merged_df['33.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)].std())

print(np.mean((merged_df['9.6'].loc[datetime(2018,12,20):datetime(2019,3,20)]) \
      -(merged_df['9.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)])))
print(np.mean((merged_df['19.6'].loc[datetime(2018,12,20):datetime(2019,3,20)]) \
      -(merged_df['19.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)])))
print(np.mean((merged_df['33.6'].loc[datetime(2018,12,20):datetime(2019,3,20)]) \
      -(merged_df['33.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)])))

print(np.sqrt(np.sum(((merged_df['9.6'].loc[datetime(2018,12,20):datetime(2019,3,20)]) \
      -(merged_df['9.6o'].loc[datetime(2018,12,20):datetime(2019,3,20)]))**2)/len(merged_df['9.6'].loc[datetime(2018,12,20):datetime(2019,3,20)])))
print(np.sqrt(np.sum(((merged_df['19.6'].loc[datetime(2018,12,20):datetime(2019,3,20)]) \
...
print(np.sqrt(np.sum(((merged_df['33.6'].loc[datetime(2018,12,20):datetime(2019,3,20)]) \
...
print(merged_df['9.6'].loc[datetime(2019,3,20):datetime(2019,6,20)] \
      .corr(merged_df['9.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)]))
print(merged_df['19.6'].loc[datetime(2019,3,20):datetime(2019,6,20)] \
      .corr(merged_df['19.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)]))
print(merged_df['33.6'].loc[datetime(2019,3,20):datetime(2019,6,20)] \
      .corr(merged_df['33.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)]))

print(merged_df['9.6'].loc[datetime(2019,3,20):datetime(2019,6,20)].std())
print(merged_df['19.6'].loc[datetime(2019,3,20):datetime(2019,6,20)].std())
print(merged_df['33.6'].loc[datetime(2019,3,20):datetime(2019,6,20)].std())

print(merged_df['9.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)].std())
print(merged_df['19.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)].std())
print(merged_df['33.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)].std())

print(np.mean((merged_df['9.6'].loc[datetime(2019,3,20):datetime(2019,6,20)]) \
      -(merged_df['9.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)])))
print(np.mean((merged_df['19.6'].loc[datetime(2019,3,20):datetime(2019,6,20)]) \
      -(merged_df['19.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)])))
print(np.mean((merged_df['33.6'].loc[datetime(2019,3,20):datetime(2019,6,20)]) \
      -(merged_df['33.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)])))

print(np.sqrt(np.sum(((merged_df['9.6'].loc[datetime(2019,3,20):datetime(2019,6,20)]) \
      -(merged_df['9.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)]))**2)/len(merged_df['9.6'].loc[datetime(2019,3,20):datetime(2019,6,20)])))
print(np.sqrt(np.sum(((merged_df['19.6'].loc[datetime(2019,3,20):datetime(2019,6,20)]) \
      -(merged_df['19.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)]))**2)/len(merged_df['19.6'].loc[datetime(2019,3,20):datetime(2019,6,20)])))
print(np.sqrt(np.sum(((merged_df['33.6'].loc[datetime(2019,3,20):datetime(2019,6,20)]) \
      -(merged_df['33.6o'].loc[datetime(2019,3,20):datetime(2019,6,20)]))**2)/len(merged_df['33.6'].loc[datetime(2019,3,20):datetime(2019,6,20)])))

# %% Summer

print(merged_df['9.6'].loc[datetime(2019,6,20):datetime(2019,9,20)] \
      .corr(merged_df['9.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)]))
print(merged_df['19.6'].loc[datetime(2019,6,20):datetime(2019,9,20)] \
      .corr(merged_df['19.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)]))
print(merged_df['33.6'].loc[datetime(2019,6,20):datetime(2019,9,20)] \
      .corr(merged_df['33.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)]))

print(merged_df['9.6'].loc[datetime(2019,6,20):datetime(2019,9,20)].std())
print(merged_df['19.6'].loc[datetime(2019,6,20):datetime(2019,9,20)].std())
print(merged_df['33.6'].loc[datetime(2019,6,20):datetime(2019,9,20)].std())

print(merged_df['9.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)].std())
print(merged_df['19.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)].std())
print(merged_df['33.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)].std())

print(np.mean((merged_df['9.6'].loc[datetime(2019,6,20):datetime(2019,9,20)]) \
      -(merged_df['9.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)])))
print(np.mean((merged_df['19.6'].loc[datetime(2019,6,20):datetime(2019,9,20)]) \
      -(merged_df['19.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)])))
print(np.mean((merged_df['33.6'].loc[datetime(2019,6,20):datetime(2019,9,20)]) \
      -(merged_df['33.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)])))

print(np.sqrt(np.sum(((merged_df['9.6'].loc[datetime(2019,6,20):datetime(2019,9,20)]) \
      -(merged_df['9.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)]))**2)/len(merged_df['9.6'].loc[datetime(2019,6,20):datetime(2019,9,20)])))
print(np.sqrt(np.sum(((merged_df['19.6'].loc[datetime(2019,6,20):datetime(2019,9,20)]) \
      -(merged_df['19.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)]))**2)/len(merged_df['19.6'].loc[datetime(2019,6,20):datetime(2019,9,20)])))
print(np.sqrt(np.sum(((merged_df['33.6'].loc[datetime(2019,6,20):datetime(2019,9,20)]) \
      -(merged_df['33.6o'].loc[datetime(2019,6,20):datetime(2019,9,20)]))**2)/len(merged_df['33.6'].loc[datetime(2019,6,20):datetime(2019,9,20)])))


# %% Fall

print(merged_df['9.6'].loc[datetime(2019,9,20):datetime(2019,12,20)] \
      .corr(merged_df['9.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)]))
print(merged_df['19.6'].loc[datetime(2019,9,20):datetime(2019,12,20)] \
      .corr(merged_df['19.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)]))
print(merged_df['33.6'].loc[datetime(2019,9,20):datetime(2019,12,20)] \
      .corr(merged_df['33.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)]))

print(merged_df['9.6'].loc[datetime(2019,9,20):datetime(2019,12,20)].std())
print(merged_df['19.6'].loc[datetime(2019,9,20):datetime(2019,12,20)].std())
print(merged_df['33.6'].loc[datetime(2019,9,20):datetime(2019,12,20)].std())

print(merged_df['9.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)].std())
print(merged_df['19.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)].std())
print(merged_df['33.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)].std())

print(np.mean((merged_df['9.6'].loc[datetime(2019,9,20):datetime(2019,12,20)]) \
      -(merged_df['9.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)])))
print(np.mean((merged_df['19.6'].loc[datetime(2019,9,20):datetime(2019,12,20)]) \
      -(merged_df['19.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)])))
print(np.mean((merged_df['33.6'].loc[datetime(2019,9,20):datetime(2019,12,20)]) \
      -(merged_df['33.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)])))

print(np.sqrt(np.sum(((merged_df['9.6'].loc[datetime(2019,9,20):datetime(2019,12,20)]) \
      -(merged_df['9.6o'].loc[datetime(2019,9,20):datetime(2019,12,20)]))**2)/len(merged_df['9.6'].loc[datetime(2019,9,20):datetime(2019,12,20)])))
print(np.sqrt(np.sum(((merged_df['19.6'].loc[datetime(2019,9,20):datetime(2019,12,20)]) \
...
print(np.sqrt(np.sum(((merged_df['33.6'].loc[datetime(2019,9,20):datetime(2019,12,20)]) \
...
dfbt.to_csv('clinic_percentile_WL_sd4.csv',header=True)

# %% 

merged_df.to_csv('clinic_all_WL_sd4.csv',header=True)
