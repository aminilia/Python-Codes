...
ax[0].plot(dfeup.mean(),dpe['Depth Below Surface'],'b',linewidth=3)
ax[0].plot(dfeun.mean(),dpe['Depth Below Surface'],'r',linewidth=3)
...
ax[1].plot(dfevp.mean(),dpe['Depth Below Surface'],'b',linewidth=3)
ax[1].plot(dfevn.mean(),dpe['Depth Below Surface'],'r',linewidth=3)
...
plt.savefig('East_General_Profiles.png',dpi=300)


fig, ax=plt.subplots(1,2,figsize=(9,5))
ax[0].plot(dfmup.mean(),dpm['Depth Below Surface'],'b',linewidth=3)
ax[0].plot(dfmun.mean(),dpm['Depth Below Surface'],'r',linewidth=3)
ax[0].legend(['East','West'],fontsize=10)
...
ax[1].plot(dfmvp.mean(),dpm['Depth Below Surface'],'b',linewidth=3)
ax[1].plot(dfmvn.mean(),dpm['Depth Below Surface'],'r',linewidth=3)
ax[1].legend(['East','West'],fontsize=10)
...
ax[1].invert_yaxis()
ax[1].grid(linewidth=0.3)
plt.savefig('Main_General_Profiles.png',dpi=300)


fig, ax=plt.subplots(1,2,figsize=(9,5))
ax[0].plot(dfwup.mean(),dpw['Depth Below Surface'],'b',linewidth=3)
ax[0].plot(dfwun.mean(),dpw['Depth Below Surface'],'r',linewidth=3)
ax[0].legend(['East','West'],fontsize=10)
...
ax[1].plot(dfwvp.mean(),dpw['Depth Below Surface'],'b',linewidth=3)
ax[1].plot(dfwvn.mean(),dpw['Depth Below Surface'],'r',linewidth=3)
ax[1].legend(['East','West'],fontsize=10)
...
ax[1].invert_yaxis()
ax[1].grid(linewidth=0.3)
plt.savefig('Southwest_General_Profiles.png',dpi=300)
...
plt.savefig('Plot_Wind_Rose.png')
